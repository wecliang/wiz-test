import { g as getAugmentedNamespace } from "./vendor.96977194.js";
import { c as jsxRuntime } from "./index.2da18b09.js";
import { Y as propTypes } from "./index.ddeb24a7.js";
...
function QRCode$3(typeNumber, errorCorrectLevel) {
...
proto.makeImpl = function(test, maskPattern) {
  ...
  if (this.dataCache == null) {
    this.dataCache = QRCode$3.createData(this.typeNumber, this.errorCorrectLevel, this.dataList);
  }
...
QRCode$3.PAD0 = 236;
QRCode$3.PAD1 = 17;
QRCode$3.createData = function(typeNumber, errorCorrectLevel, dataList) {
  ...
  while (true) {
    ...
    buffer.put(QRCode$3.PAD0, 8);
    if (buffer.getLengthInBits() >= totalDataCount * 8) {
      break;
    }
    buffer.put(QRCode$3.PAD1, 8);
  }
  return QRCode$3.createBytes(buffer, rsBlocks);
};
QRCode$3.createBytes = function(buffer, rsBlocks) {
  var offset = 0;
  var maxDcCount = 0;
  var maxEcCount = 0;
...
var QRCode_1 = QRCode$3;
var QRCode$2 = QRCode_1;
var ErrorCorrectLevel = ErrorCorrectLevel$1;
var qrcode = function(data, opt) {
  opt = opt || {};
  var qr2 = new QRCode$2(opt.typeNumber || -1, opt.errorCorrectLevel || ErrorCorrectLevel.H);
  qr2.addData(data);
  qr2.make();
  return qr2;
};
...
var QRCode = function(_React$Component) {
  _inherits(QRCode2, _React$Component);
  function QRCode2() {
    _classCallCheck(this, QRCode2);
    return _possibleConstructorReturn(this, (QRCode2.__proto__ || Object.getPrototypeOf(QRCode2)).apply(this, arguments));
  }
  _createClass(QRCode2, [{
    key: "shouldComponentUpdate",
    value: function shouldComponentUpdate(nextProps) {
      var that = this;
      return Object.keys(QRCode2.propTypes).some(function(k) {
    ...
    value: function update() {
      ...
      var qrcode2 = qr(value);
      var canvas = getDOMNode(this.refs.canvas);
      var ctx = canvas.getContext("2d");
      var cells = qrcode2.modules;
